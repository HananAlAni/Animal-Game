...
public class Player implements Comparable<Player>{
    ...
    public void buyAnimal() {
        ...
        while (money!=0 && this.money>=checkTheCheapestAnimal()){
            ...
            System.out.println("Buy another one!");
            String input=scanner.next();
            if (input.equals("n")){
                return;
            }
        }
        System.out.println("You don't have enough money! press any key");
        scanner.next();
        return;
    }
    public void buyFood(){
        ...
        if (checkBalance()){
            System.out.println("You don't have enough money to buy. press any key to continue");
            scanner.next();
            return;
        }
    }
    ...
    public void mateAnimals(){
        ...
        int times = animals.get(Integer.parseInt(input2) - 1).animalChildren;
        ...
        while (times > 0) {
            ...
            if (chance == 1) {
                ...
                if (chance == 1) {
                    System.out.println("JIPPII it is a boy!");
                    ...
                    if (type.equals("Rabbit")) {
                        animals.add(new Rabbit(input, "male"));
                    }
                    if (type.equals("Cat")) {
                        animals.add(new Cat(input, "male"));
                    }
                    if (type.equals("Parrot")) {
                        animals.add(new Parrot(input, "male"));
                    }
                    ...
                    System.out.println("JIPPPI it is a girl!");
                    System.out.println("What name is the baby going to have?");
                    input = scanner.next();
                    if (type.equals("Dog")) {
                    ...
                    if (type.equals("Rabbit")) {
                        animals.add(new Rabbit(input, "female"));
                    }
                    if (type.equals("Cat")) {
                        animals.add(new Cat(input, "female"));
                    }
                    if (type.equals("Parrot")) {
                        animals.add(new Parrot(input, "female"));
                    }
                    if (type.equals("Horse")) {

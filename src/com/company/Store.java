...
public class Store {
    ...
    public static Animal showAnimalsForSale(Player p){
        ...
        if(input.equals("3")){
            ...
            while (true) {
                input = scanner.next();
                if (input.equals("1")) {
                    return new Rabbit(input2, "male");
                }
                if(input.equals("2")) {
                    return new Rabbit(input2, "female");
                }
                System.out.println("Not a valid move. Type 1 or 2");
            }
        }
        ...
        if(input.equals("5")){
            ...
            while (true) {
                input = scanner.next();
                if (input.equals("1")) {
                    return new Parrot(input2, "male");
                }
                if(input.equals("2")) {
                    return new Parrot(input2, "female");
                }
                System.out.println("Not a valid move. Type 1 or 2.");
            }
        }
    ...
    public static void showFoodForSale(Player p){
        ...
        if(input.equals("3")){
            ...
            p.food.add(new Carrot("Carrot",Integer.parseInt(input2)));
            return;
        }
    }
    ...
    public static void showInfoAboutAnimals(){
        ...
        System.out.println("1: DOG: Maximum age = 13 | Possible children: 4 | Food: Meat\n" +
                "2: HORSE: Maximum age = 10 | Possible children: 1 | Food: Grass\n" +
                "3: RABBIT: Maximum age = 6 | Possible children: 8 | Food: Grass\n" +
                "4: CAT: Maximum age = 12 | Possible children: 5| Food: Apple, Meat\n" +
                "5: PARROT: Maximum age = 5 | Possible children: 2 | Food: Grass");
    ...
    public static void showInfoAboutFood(){
        ...
        System.out.println("1: MEAT: Dogs and cats eats meat.\n" +
                ...
                "3: CARROT: Horses, cows and pigs eats this.");
